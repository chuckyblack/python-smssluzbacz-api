...
parser.add_argument('--use-post', metavar='use_post', type=bool, help='whether to use HTTP POST method', default=False, required=False)
parser.add_argument('--use-ssl', metavar='use_ssl', type=bool, help='whether to use ssl over HTTP', default=False, required=False)
parser.add_argument('--timeout', metavar='timeout', type=float, help='http connection timeout', default=2, required=False)
